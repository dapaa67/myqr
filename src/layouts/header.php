...
<head>
    ...
    <style> 
      ...
      @media (min-width: 768px) {
        ...
        #sidebar.is-collapsed [data-sidebar-state="collapsed"] {
          display: flex;
        }
    ...
    <aside id="sidebar" class="w-64 bg-white shadow-lg flex flex-col border-r border-gray-200 fixed inset-y-0 left-0 z-40 transform -translate-x-full md:translate-x-0">
        <div class="h-16 flex items-center justify-between border-b border-gray-200 flex-shrink-0 px-4">
            <h1 class="text-2xl font-bold w-full text-center">
                <span data-sidebar-state="expanded" class="bg-gradient-to-r from-blue-500 to-purple-500 text-transparent bg-clip-text">Absensi<span class="text-blue-500">QR</span></span>
                <span data-sidebar-state="collapsed" class="hidden text-blue-500">AQR</span>
            </h1>
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            <?php if ($_SESSION['role'] === 'admin'): ?>
                <a href="index.php" title="Dashboard" class="nav-link flex items-center px-4 py-2.5 rounded-lg <?php echo is_active('index.php') ? 'bg-blue-600 text-white shadow-md' : 'text-slate-600 hover:bg-gray-200'; ?>">
                    <svg class="w-6 h-6 flex-shrink-0 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                    <span class="font-medium" data-sidebar-state="expanded">Dashboard</span>
                </a>
                <a href="rekap.php" title="Rekap Absensi" class="nav-link flex items-center px-4 py-2.5 rounded-lg <?php echo is_active('rekap.php') ? 'bg-blue-600 text-white shadow-md' : 'text-slate-600 hover:bg-gray-200'; ?>">
                    <svg class="w-6 h-6 flex-shrink-0 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    <span class="font-medium" data-sidebar-state="expanded">Rekap</span>
                </a>
                <a href="shifts.php" title="Manajemen Shift" class="nav-link flex items-center px-4 py-2.5 rounded-lg <?php echo is_active(['shifts.php', 'tambah_shift.php']) ? 'bg-blue-600 text-white shadow-md' : 'text-slate-600 hover:bg-gray-200'; ?>">
                    <svg class="w-6 h-6 flex-shrink-0 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    <span class="font-medium" data-sidebar-state="expanded">Shift</span>
                </a>
                <a href="users.php" title="Manajemen User" class="nav-link flex items-center px-4 py-2.5 rounded-lg <?php echo is_active(['users.php', 'edit_user.php']) ? 'bg-blue-600 text-white shadow-md' : 'text-slate-600 hover:bg-gray-200'; ?>">
                    ...
                    <span class="font-medium" data-sidebar-state="expanded">User</span>
                </a>
            <?php else: ?>
                <a href="index.php" title="Dashboard" class="nav-link flex items-center px-4 py-2.5 rounded-lg <?php echo is_active('index.php') ? 'bg-blue-600 text-white shadow-md' : 'text-slate-600 hover:bg-gray-200'; ?>">
                    <svg class="w-6 h-6 flex-shrink-0 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
        ...
        <div class="mt-auto p-4 border-t border-gray-200 space-y-2">
             <a href="#" title="<?php echo htmlspecialchars($_SESSION['nama_lengkap']); ?>" class="flex items-center px-4 py-2.5 rounded-lg text-slate-600 hover:bg-gray-200">
                ...
                <div class="ml-3" data-sidebar-state="expanded">
            ...
            <a href="../auth/logout.php" title="Logout" class="flex items-center px-4 py-2.5 rounded-lg text-red-600 hover:bg-red-50">
                ...
                <span class="ml-3 font-medium" data-sidebar-state="expanded">Logout</span>
            </a>
            <button id="sidebar-toggle-desktop" title="Lipat Sidebar" class="hidden md:flex items-center w-full px-4 py-2.5 rounded-lg text-slate-600 hover:bg-gray-200">
                <svg class="w-6 h-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 19l-7-7 7-7m8 14l-7-7 7-7"></path></svg>
                <span class="ml-2" data-sidebar-state="expanded">Lipat Sidebar</span>
            </button>
        </div>
    </aside>
